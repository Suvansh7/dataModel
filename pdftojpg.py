...
def locate(img_lst):
    ...
    for i in img_lst:
        if c < 43:
            ...
            im = i  # Use the Pillow image directly
            im.save(f"C:\\Users\\Utkar\\OneDrive\\Desktop\\Miniproject\\dataModel\\set\\sheet2\\{total - c}.jpg")
            c = c + 1
            total2 = c
        else:
            im = i  # Use the Pillow image directly
            im.save(f"C:\\Users\\Utkar\\OneDrive\\Desktop\\Miniproject\\dataModel\\set\\sheet3\\{total2 - c}.jpg")
            c = c + 1
